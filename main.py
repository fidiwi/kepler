...
filename = 'Probedaten/Beispiesamples/Mail_lutz_3/Luecken/5_percent/10000_2.0_05_.37500,.42500_pos.csv'
anzahlWindows = 100
...
linReg1, linReg2, filledGaps = ultraClass.fillGaps(gapBereiche, readAmountPerSection, xAxisDiagram)
print(filledGaps)
